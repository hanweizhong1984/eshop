...
class Page
{
	...
	public function GetPageHtml()
	{
	    ...
	    $gong = $cookie=='en-us'?'Total':'共';
	    $dataN = $cookie=='en-us'?'pieces of data':'条数据';
	    $pageN = $cookie=='en-us'?'pages':'页';
		...
		$this->html .= '<div>';
		$this->html .= '<span>'.$gong.' '.$this->total.' '.$dataN.'</span>';
		$this->html .= '&nbsp;&nbsp;&nbsp;<span>'.$gong.' '.$this->page_total.' '.$pageN.'</span>';
		$this->html .= '</div>';
		$this->html .= '</ul>';
