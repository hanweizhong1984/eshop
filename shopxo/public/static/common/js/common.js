		...
		submit: function(e)
		{
			...
			if(this.isFormValid())
			{
				...
				$.ajax({
					...
					type:method,
	                dataType:"json",
	                timeout:$form.attr('timeout') || 3000000,
...
{
	var cookie = $.cookie("think_var");
	var title = e.attr('data-title') || (cookie=='en-us'?'Warm prompt':'温馨提示');
	var msg = e.attr('data-msg') || (cookie=='en-us'?'Can not be recovered after deletion, are you sure to continue?':'删除后不可恢复、确认操作吗？');
...
function ConfirmNetworkAjax(e)
{
	var cookie = $.cookie("think_var");
	var title = e.attr('data-title') || (cookie=='en-us'?'Warm prompt':'温馨提示');
	var msg = e.attr('data-msg') || (cookie=='en-us'?"Can\'t be recovered after operation, are you sure to continue?":"操作后不可恢复、确认继续吗？");
