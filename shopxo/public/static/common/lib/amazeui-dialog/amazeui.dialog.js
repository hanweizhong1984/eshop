...
dialog.confirm = function(options) {
  ...
  var cancle=cookie=='en-us'?'Cancel':'取消';
  var confirm=cookie=='en-us'?'OK':'确定';
  var html = [];
  ...
  html.push('<span class="am-modal-btn" data-am-modal-cancel>'+cancle+'</span>');
  html.push('<span class="am-modal-btn" data-am-modal-confirm>'+confirm+'</span>');
  html.push('</div>');
  html.push('</div>');
  html.push('</div>');
