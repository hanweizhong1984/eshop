...
$(function()
{
    ...
    $('.login-event').on('click', function()
    {
        ...
        if(__user_id__ == 0)
        {
            ModalLoad(__modal_login_url__, $.cookie('think_var')=='en-us'?'LogIn':'登录', 'common-popup-modal-login', 'common-login-modal');
            return false;
        }
    });
    ...
    $('.toggle').click(function(){
        ...
        $.get($('.menu-hd').data('change-lan-url'),data,function(){
            location.reload();
        })
    })
});