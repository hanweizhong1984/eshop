...
class NavigationService
{
    ...
    public static function UsersPersonalShowFieldList($params = [])
    {
        ...
        $data = [
            'avatar'            =>  [
                'name' => '头像',
                'tips' => '<a href="javascript:;" data-am-modal="{target:\'#user-avatar-popup\'}">'.lang("修改").'</a>'
            ],
            'nickname'          =>  [
                'name' => '昵称'
            ],
            ...
            'mobile_security'   =>  [
                'name' => '手机号码',
                /*'tips' => '<a href="'.MyUrl('index/safety/mobileinfo').'">'.lang("修改").'</a>'*/
            ],
            'email_security'    =>  [
                'name' => '电子邮箱',
                /*'tips' => '<a href="'.MyUrl('index/safety/emailinfo').'">'.lang("修改").'</a>'*/
            ],
            'add_time_text'     =>  [
                'name' => '注册时间'
            ],
