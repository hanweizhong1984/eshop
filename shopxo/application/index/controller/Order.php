...
class Order extends Common
{
    ...
    public function Respond()
    {
        ...
        {
            $ret = ($params['appoint_status'] == 0) ? DataReturn($cookie=='en-us'?'Pay success':'支付成功', 0) : DataReturn($cookie=='en-us'?'Pay failed':'支付失败', -100);
        ...
        $this->assign('to_title', $cookie=='en-us'?'My Orders':'我的订单');
